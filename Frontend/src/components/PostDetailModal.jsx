...
export function PostDetailModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200" onClick={onClose}>
      ...
      <div className="relative w-full max-w-md md:max-w-5xl h-[85vh] md:h-[80vh] bg-background rounded-xl flex flex-col md:flex-row overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
        
        {/* --- Left: Image/Media --- */}
        <div className="w-full md:w-[60%] bg-black flex items-center justify-center relative h-64 md:h-full">
          {post.media_url ? (
             (post.media_type?.startsWith('video') || post.media_url.endsWith('.mp4')) ? (
                        ...
                        <div key={idx} className="flex gap-3">
                            ...
                            <div className="text-sm">
                                <span 
                                    ...
                                    onClick={() => { onUserClick(comment.username); onClose(); }}
                                >
